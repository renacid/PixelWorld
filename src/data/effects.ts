...
export type TrapVisual = 'largeRock' | 'pollen' | 'blueBloom' | 'fallingStrike' | 'elementalSwirl' | 'quake'|'iceLance'|'windVortex' | 'iceShield' | 'shatter' | 'chestBurst' | 'snare' | 'fireBlast' | 'fallingRocks' | 'healingGlow' | 'summonRing';
