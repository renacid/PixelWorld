...
export const INSTALLATIONS: Record<InstallationKind, InstallationDefinition> = {
  ...
  goblinNest: { name: 'ゴブリンの巣穴', spawn: { radius:6, chance:.1, max:3, pool:[{value:'goblin',weight:6},{value:'goblinArcher',weight:3},{value:'goblinMage',weight:1}] } },
};
/** overridesで巣穴ごとにも抽選表・上限を変更可能。spawnedは累計で保存。 */
export type Installation = { id:string; kind:InstallationKind; position:Point; spawned:number; overrides?:Partial<InstallationDefinition> };
