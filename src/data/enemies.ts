...
export const ENEMIES = {
  ...
  goblinMage: define({  name:'ゴブリン・メイジ', hp: 25, attack: 3, detectionRange: 4, mp: 15, experience: 7, sprite: 'mage', skills: ['fireball', 'teleport', 'prayer'] }),
  treant: define({      name:'トレント', hp: 35, experience: 5, attack: 5, sprite: 'treant', fireVulnerability:1, renderHeight: 44, immobile: true, attribute: 'earth', innateAttribute: 'earth', mp: 20, detectionRange: 5, skills: ['forestBlessing', 'stoneThrow'], skillChances: { stoneThrow: .5, forestBlessing: .2 }, drops: [{ loot: { type: 'item', id: 'potion' }, chance: .7 }] }),
  slime: define({       name:'スライム', hp: 12, experience: 2, attack: 2, sprite: 'slime',　detectionRange: 3, pattern: 'patrol', bob: true, drops: [{ loot: { type: 'item', id: 'potion' }, chance: .08 }, { loot: { type: 'skill', id: 'fireball' }, chance: .02 }] }),
  goblin: define({ experience: 3, name: 'ゴブリン', hp: 17, attack: 3, sprite: 'goblin', detectionRange: 4, mp: 5, skills: ['stoneThrow'], drops: [{ loot: { type: 'item', id: 'ether' }, chance: .07 }, { loot: { type: 'item', id: 'potion' }, chance: .03 }, { loot: { type: 'skill', id: 'thunder' }, chance: .02 }] }),
  wolf: define({ experience: 3, name: '森の狼', hp: 15, attack: 3, sprite: 'wolf', detectionRange: 5, mp: 5, skills: ['lunge'], drops: [{ loot: { type: 'item', id: 'potion' }, chance: .06 }, { loot: { type: 'item', id: 'ether' }, chance: .03 }, { loot: { type: 'skill', id: 'tornado' }, chance: .02 }] }),
  golem: define({ experience: 12, name: 'ゴーレム', hp: 60, attack: 5, mp: 20, size: 2, sprite: 'golem', renderLift: 0, renderScale: 2, renderHeight: 80, wideAttack: true, skillSelection: 'exclusive', skills: ['quietGaze', 'rockThrow', 'heavyStrike'], drops: [{ loot: { type: 'item', id: 'summon' }, chance: .05 }, { loot: { type: 'item', id: 'potion' }, chance: .1 }] }),
};
