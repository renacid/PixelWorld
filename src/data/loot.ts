...
export const skillPool: Weighted<SkillId>[] = ['thunderPrison','meteor','icePillar','thunderArmor','iceLance','fireWall','tornadoSummon','earthquake','summonSpirit', 'iceShield', 'sweep', 'vacuumSlash', 'chainLightning', 'fireball', 'thunder', 'tornado', 'firerain', 'warp', 'icestone', 'groundbreak'].map(value => ({ value: value as SkillId, weight: 1 }));
