...
export const RARE_ITEMS: Weighted<ItemId>[] = [{ value: 'scope', weight: 1 }, { value: 'summon', weight: 1 }];
const skillPool: Weighted<SkillId>[] = ['fireball', 'thunder', 'tornado', 'firerain', 'warp', 'icestone', 'groundbreak'].map(value => ({ value: value as SkillId, weight: 1 }));
