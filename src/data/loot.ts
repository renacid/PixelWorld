...
export const skillPool: Weighted<SkillId>[] = ['sweep', 'vacuumSlash', 'chainLightning', 'fireball', 'thunder', 'tornado', 'firerain', 'warp', 'icestone', 'groundbreak'].map(value => ({ value: value as SkillId, weight: 1 }));
