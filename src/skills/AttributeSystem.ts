...
export const ATTRIBUTE_DURATION: Record<Attribute, number> = { fire: 10, ice: 10, thunder: 10, earth: 10, wind: 10, neutral: 0, physical: 0, nature: 10 };
