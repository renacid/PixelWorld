...
export function drawInstallation(ctx:CanvasRenderingContext2D,kind:InstallationKind,x:number,y:number):void{
 ...
 if(kind==='goblinBanner'){
  box('#593c30',4,2,2,13);box('#eac269',4,1,2,2);box('#812f3c',6,3,8,7);box('#c4484b',6,3,6,5);box('#f6d891',8,4,3,1);box('#f6d891',9,4,1,4);box('#735944',2,14,7,1);
