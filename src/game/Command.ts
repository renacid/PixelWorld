...
export type Command = { type: 'move'; direction: Direction } | { type: 'cast'; skillId: SkillId; direction: Direction; target?: Point } | { type: 'item'; slot: number; skillId?: SkillId } | { type: 'wait' } | { type: 'sleep' };
